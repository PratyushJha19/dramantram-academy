...
const WORK = [
  { id: 1, title: 'Cinematic Ad', category: 'Production', img: 'https://images.unsplash.com/photo-1492691527719-9d1e07e534b4?auto=format&fit=crop&q=80&w=600' },
  { id: 2, title: 'Brand Identity', category: 'Graphic Design', img: 'https://images.unsplash.com/photo-1558655146-d09347e92766?auto=format&fit=crop&q=80&w=600' },
  { id: 3, title: 'Music Video', category: 'Direction', img: 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?auto=format&fit=crop&q=80&w=600' },
  { id: 4, title: 'UI Concept', category: 'Design', img: 'https://images.unsplash.com/photo-1559028012-481c04fa702d?auto=format&fit=crop&q=80&w=600' },
  { id: 5, title: 'Short Film', category: 'Cinema', img: 'https://images.unsplash.com/photo-1478720568477-152d9b164e26?auto=format&fit=crop&q=80&w=600' },
  { id: 6, title: 'Social Campaign', category: 'Marketing', img: 'https://images.unsplash.com/photo-1557804506-669a67965ba0?auto=format&fit=crop&q=80&w=600' },
];
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          <div className="text-center md:text-left">
            <h2 className="oswald text-[#FF0000] uppercase tracking-[0.4em] text-xs mb-4 font-bold">Showcase</h2>
            <h3 className="oswald text-4xl md:text-6xl font-black uppercase tracking-tighter">The Studio <br /><span className="text-gradient-red">Output.</span></h3>
          </div>
          <p className="max-w-md text-gray-500 text-sm md:text-base italic font-medium text-center md:text-right">
            "We don't just teach. We build the industry standard through every frame we render."
          </p>
        </div>
