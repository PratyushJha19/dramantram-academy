      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          <div className="text-center lg:text-left">
             <div className="oswald text-[#FFD700] uppercase tracking-[0.4em] text-xs mb-4 font-bold">The Reality</div>
             ...
             <div className="space-y-6 max-w-lg mx-auto lg:mx-0">
               ...
               <p className="text-gray-500 italic text-sm md:text-base">
                 "Helping creators transform from raw talent into <span className="text-[#FFD700]">award-winning</span> industry professionals."
               </p>
             </div>
          </div>
